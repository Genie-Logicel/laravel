        ...
        <div class="flex justify-between items-center">
            ...
            <div>
                <form action="{{ route('member.create') }}" method="get">
                    @csrf
                    <button type="submit" class="btn btn-primary font-bold">Nouvelle membre</button>
                </form>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{ $index + 1 }}</th>
                                    <td class="text-left capitalize">{{ $item->nom }}</td>
                                    <td class="text-left capitalize">{{ $item->adresse }}</td>
